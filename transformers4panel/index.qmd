...
Deep-learning language models learn directly from data, via **embeddings**:

- how tokens relate to one another without manual feature engineering
...
- Requires no labeled data — the text itself is the supervision
...
- The dominant pre-training objective for autoregressive models (GPT family, etc.)
